export function IconThunder() {
    return (
      <svg class="thunder-cloud" viewBox="0 0 512 512">
  ...
  export function IconRain() {
    return (
        <svg class="rain-cloud"  viewBox="0 0 512 512">
  ...
  export function IconSnow() {
    return (
      <svg class="snow-cloud" viewBox="0 0 512 512">
  ...
  export function SunCloud() {
    return (
      <svg class="sun-cloud"  viewBox="0 0 512 512">
  ...
  export function Sunshine() {
    return (
      <svg class="sunshine"  viewBox="0 0 512 512">
  ...
  export function IconWindy() {
    return (
      <svg class="windy-cloud"  viewBox="0 0 512 512">
        <g class="cloud-wrap">
